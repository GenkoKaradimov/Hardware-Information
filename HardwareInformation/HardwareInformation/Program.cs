...
namespace HardwareInformation
{
	class Program
	{
		...
		{
			Console.WriteLine("Device Hardware Information");
			Console.WriteLine("---------------------------");
			Console.WriteLine("");

			Console.WriteLine("Processor: ");
			Console.WriteLine("Processor Id: " + GetProcessorId());
			Console.WriteLine("Processor Manufacturer: " + GetCPUManufacturer());
			Console.WriteLine("Processor Clock Speed: " + GetCPUCurrentClockSpeed());
			Console.WriteLine("Processor Speed In GHz: " + GetCpuSpeedInGHz());
			Console.WriteLine("");

			Console.WriteLine("HDD/SSD: ");
			Console.WriteLine("Serial numbers: " + GetProcessorId());

			Console.WriteLine("");
			Console.WriteLine("-------------------------------------------");
			Console.WriteLine("Github: GenkoKaradimov/Hardware-Information");
			Console.WriteLine("https://www.karadimov-development.com");
			...
			bool notExit = true;
			while (notExit)
				if (Console.ReadKey(true).Key == ConsoleKey.Escape) notExit = false;
		}
		...
		static string GetCPUCurrentClockSpeed()
		{
			int cpuClockSpeed = 0;
			//create an instance of the Managemnet class with the
			//Win32_Processor class
